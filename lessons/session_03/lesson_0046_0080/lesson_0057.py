...
print(
    """Orientações:
1) Cada pergunta tem quatro alternativas [a],[b],[c],[d] de respostas.
2) Somente UMA das alternativas é a CORRETA, logo:
    Total de acerto >= 60% -> APROVADO
    Total de acerto < 60% -> REPROVADO
"""
)
